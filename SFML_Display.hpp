...
class SFML_Display
{
  ...
  public:
	//constructor
	SFML_Display(unsigned int wSize_x, unsigned int wSize_y) : wSize_x(wSize_x), wSize_y(wSize_y), m_window({wSize_x, wSize_y}, "MainWindow")
	{
		loadTextures();
	...
	void StartMainLoop(Manager &M, Plotter &P)
	{
		...
		while (m_window.isOpen())
		{
			...
			if (!GamePaused)
			{
				...
				M.updateAll(frame, textureFood, textureCreature, textureHunter, font);
